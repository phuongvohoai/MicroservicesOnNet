...
using WAL.Identity.API.Configuration;

namespace WAL.Identity.API.Seeder
{
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context, IConfiguration configuration)
        {
            ...
            {
                foreach (var client in ApiConfig.GetClients())
                {
            ...
            {
                foreach (var resource in ApiConfig.GetResources())
                {
            ...
            {
                foreach (var api in ApiConfig.GetApis())
                {
